...
// MarshalInt64 writes the MUS encoding (Varint) of a int64 value.
//
...
// MarshalInt32 writes the MUS encoding (Varint) of a int32 value.
//
// Returns the number of used bytes and a Writer error.
...
// MarshalInt16 writes the MUS encoding (Varint) of a int16 value.
//
// Returns the number of used bytes and a Writer error.
...
// MarshalInt8 writes the MUS encoding (Varint) of a int8 value.
//
// Returns the number of used bytes and a Writer error.
...
// MarshalInt writes the MUS encoding (Varint) of a int value.
//
// Returns the number of used bytes and a Writer error.
...
// UnmarshalInt64 reads a MUS-encoded (Varint) int64 value.
//
...
// UnmarshalInt32 reads a MUS-encoded (Varint) int32 value.
//
...
// UnmarshalInt16 reads a MUS-encoded (Varint) int16 value.
//
...
// UnmarshalInt8 reads a MUS-encoded (Varint) int8 value.
//
...
// UnmarshalInt reads a MUS-encoded (Varint) int value.
//

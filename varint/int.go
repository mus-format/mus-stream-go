...
func (int64Ser) Marshal(v int64, w mus.Writer) (n int, err error) {
...
func (int64Ser) Unmarshal(r mus.Reader) (v int64, n int, err error) {
...
// or a Reader error.
func (int64Ser) Skip(r mus.Reader) (n int, err error) {
...
//
// In addition to the number of bytes written, it may also return a Writer error.
func (int32Ser) Marshal(v int32, w mus.Writer) (n int, err error) {
...
// return com.ErrOverflow or a Reader error.
func (int32Ser) Unmarshal(r mus.Reader) (v int32, n int, err error) {
...
// In addition to the number of bytes read, it may also return com.ErrOverflow
// or a Reader error.
func (int32Ser) Skip(r mus.Reader) (n int, err error) {
...
//
// In addition to the number of bytes written, it may also return a Writer error.
func (int16Ser) Marshal(v int16, w mus.Writer) (n int, err error) {
...
// return com.ErrOverflow or a Reader error.
func (int16Ser) Unmarshal(r mus.Reader) (v int16, n int, err error) {
...
// In addition to the number of bytes read, it may also return com.ErrOverflow
// or a Reader error.
func (int16Ser) Skip(r mus.Reader) (n int, err error) {
...
//
// In addition to the number of bytes written, it may also return a Writer error.
func (int8Ser) Marshal(v int8, w mus.Writer) (n int, err error) {
...
// return com.ErrOverflow or a Reader error.
func (int8Ser) Unmarshal(r mus.Reader) (v int8, n int, err error) {
...
// In addition to the number of bytes read, it may also return com.ErrOverflow
// or a Reader error.
func (int8Ser) Skip(r mus.Reader) (n int, err error) {
	return Uint8.Skip(r)
}
...
//
// In addition to the number of bytes written, it may also return a Writer error.
func (intSer) Marshal(v int, w mus.Writer) (n int, err error) {
...
// return com.ErrOverflow or a Reader error.
func (intSer) Unmarshal(r mus.Reader) (v int, n int, err error) {

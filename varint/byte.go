...
func (byteSer) Marshal(v byte, w mus.Writer) (n int, err error) {
...
func (byteSer) Unmarshal(r mus.Reader) (v byte, n int, err error) {
...
// or a Reader error.
func (byteSer) Skip(r mus.Reader) (n int, err error) {

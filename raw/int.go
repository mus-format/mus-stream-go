...
//
// In addition to the int32 value, returns the number of used bytes and a
// Reader error.
...
//
// In addition to the int16 value, returns the number of used bytes and a
// Reader error.
...
//
// In addition to the int8 value, returns the number of used bytes and a
// Reader error.
...
//
// In addition to the int value, returns the number of used bytes and a
// Reader error.

# Contributing to mus-stream-go

First off, thank you for considering contributing to **mus-stream-go**! It's 
...
2. Clone your fork locally:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/mus-stream-go.git
   cd mus-stream-go
   ```
...
3. Add the upstream repository as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/mus-format/mus-stream-go.git
   ```

## Reporting Issues

- **Bugs**: Use the [GitHub Issues](https://github.com/mus-format/mus-stream-go/issues)
...
By contributing to **mus-stream-go**, you agree that your contributions will be 
